...
<head>
    ...
    <!--Texto da aba-->
    <title>Criar novo custo - Luna</title>
</head>
...
<div class='barra'>
<!--Traz do arquivo-->
<?php $id = 'criaCusto'; include('barra.php'); ?>
...
.glebao{
    ...
    .canvas{
        ...
        <div class='entradas'>
            ...
            <form method="POST" action="42adicionaCusto.php">
                <div class='pergunta'>
                    <h3>Nome do novo custo: <input type='text' name='nomeCusto'></h3>
                    <?php
                        //Verifica se existe a variavel erro dentro das variaveis globais
                        if (isset($_SESSION['erro'])){
                            if($_SESSION['erro']=="Custo ja cadastrado"){
                    ?>
