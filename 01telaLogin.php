...
<body>
	...
	<form action="03fazLogin.php" method='post'>
		<!--Imagem no topo-->
		...
		<div class="container">
			...
			<?php
				//Verifica se existe a variavel erro dentro das variaveis globais
				if (isset($_SESSION['erro'])){
					if($_SESSION['erro']=="Senha incorreta"){
			?>
						<label for="erro" class="erro"><b><?php echo $_SESSION['erro'] ?></b></label>
						<?php  
							//Atribui nada a erro, caso o usuaro atualize a pagina não mostrara o erro novamente
			...
			?>
						<label for="cadastroS" class="sucesso"><b><?php echo $_SESSION['msg']; ?></b></label>
						<?php  
							//Atribui nada a erro, caso o usuaro atualize a pagina não mostrara o erro novamente
							$_SESSION['msg']='';
						?>
	    ...
	    <!--Forgot password-->
		<div class="container">
			<span class="psw"> <a href="61esqueciSenha.php">Esqueceu a senha?</a></span>
		</div>
		<!--Cadastro-->
		<div class="container">
			<span class="psw"> Não tem uma conta? <a class="cadastro" href="00telaCadastro.php">Cadastre-se</a></span>
		</div>
	</form>
	<style>
	button:hover {
