...
<body>
	...
	<form action="64verificaPergunta.php" method='post'>
		<!--Imagem no topo-->
		...
		<div class="container">
			...
			<!--Input-->
			<div class="exibe">
				<label for="pergunta"><b><?php echo $_SESSION['perguntaS']; ?></b></label>
			</div>
			...
			<?php
				...
				if (isset($_SESSION['erro'])){
					if($_SESSION['erro']=="Resposta incorreta"){
			?>
						<label for="erro" class="exibe erro"><b><?php echo $_SESSION['erro'] ?></b></label>
						<?php  
