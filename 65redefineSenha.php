...
<body>
	...
	<form action="66mudaSenha.php" method='post'>
		<!--Imagem no topo-->
		...
		<div class="container">
			...
			<!--Input-->
			<label for="uname"><b>Nova senha</b></label>
			<input type="password" placeholder="Entre a Nova Senha" name="psw" required>
			<?php
				//Verifica se existe a variavel erro dentro das variaveis globais
				if (isset($_SESSION['erro'])){
					if($_SESSION['erro']=="Senha diferente"){
			?>
